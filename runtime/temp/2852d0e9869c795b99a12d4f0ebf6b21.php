<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\www\tp\public/../application/home/view/default/notice\index.html";i:1507431519;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
        ...
        <div class="row noticeList">
            <a href="<?php echo url('details?id='.$notice['id']); ?>">
                ...
                <div class="">
                    ...
                    <p class="info">浏览次数:<?php echo $notice['view']; ?><span class="pull-right"><?php echo time_format($notice['create_time']); ?></span> </p>
                </div>
            </a>
        </div>
        <?php endforeach;?>
