<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\www\tp\public/../application/admin/view/default/vali\index.html";i:1507439441;s:67:"D:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo url('vali/index'); ?>"><i class="btn-search"></i></a>
			</div>
		</div>
	</div>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
					<tr data-id="del?id='.$user['id']">
                        ...
                        <td><?php echo !empty($user['status']) && $user['status']==1?'已通过':'未通过'; ?></td>
						<td><?php
							if($user['connect']==1){
							echo "本人";
						...
						<td>
							<a title="审核" href="javascript:;" class="vali" id="<?php echo $user['id']; ?>">通过审核</a>
							<a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$user['id']); ?>">删除</a>
						</td>
					</tr>
...
<script type="text/javascript">
    $(function() {
        $('.vali').click(function () {
            var id = $(this).attr('id');
            $.post('<?php echo url(edit); ?>',{id:id},function (data) {
				if(data=='true'){
				    alert('审核通过');
				    $(this).html('审核通过');
				}
