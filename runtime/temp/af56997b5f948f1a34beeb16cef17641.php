<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\www\tp\public/../application/admin/view/default/member\index.html";i:1507387116;s:67:"D:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
					<tr data-id="del?id='.$user['id']">
						...
						<td><?php echo $user['connect']; ?></td>
						<td><?php echo $user['tel']; ?></td>
						<td>
							<a title="审核" href="<?php echo url('edit?id='.$user['id'].'&pid='.$pid); ?>">通过审核</a>
